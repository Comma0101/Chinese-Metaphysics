...
**Product type:** Premium productized professional practice evolving into a human-plus-software service.
...
**Primary customer:** Category-aware or culturally close Chinese professional, approximately 28–45, in North America, with one consequential decision due within 90 days and the ability to pay US$388 without financial distress.

**Primary use case:** A culturally fluent second lens on a concrete career, relocation, founder, relationship, or family decision while preserving client agency.

**Jobs to be done:**

- Correct and transparently explain the BaZi chart and assumptions.
...
**Secondary audience:** Founders and executives by warm introduction after proof; consenting couples/families only after dedicated safeguards.

**Not initial:** Mainland residents, minors, low-ability-to-pay students in acute uncertainty, people seeking deterministic predictions or professional health/legal/financial advice, or repeated reassurance around the same crisis.

## Problems and Pain Points

**Core problem:** Existing options force customers to choose between culturally resonant but opaque/fear-based practitioners and cheap automated reports with inconsistent calculations and no accountable human.
...
**Emotional tension:** “I want a culturally meaningful second perspective, but I do not want to be manipulated, judged, exposed, or told that fate removes my agency.”
...
**Adjacent:** Western astrology apps, Human Design, coaching, therapy, career/immigration/domain professionals, friends/family, and doing nothing.

The detailed source of record is `docs/research/data/competitor-matrix.csv`.

## Differentiation

**Key differentiators:**

- deterministic, versioned calculation trace;
- explicit uncertainty and method choices;
...
**Anxiety:** No public practitioner identity, fear of manipulation, privacy, AI involvement, whether human review is substantive, and whether price exceeds actual usefulness.

## Customer Language

**How they describe the job:**

- “another perspective”
- “blind spots and areas of improvements”
- “多一個可參照的架構” — another framework for reference
- “career switch… before making big decisions”
- choosing an offer or whether to relocate
- a record they can revisit

**How they describe category failures:**

- “not interested in those who sells objects to improve luck”
- “don’t do it using ChatGPT”
- “3 different Bazi charts”
...
**Tone:** Serious, restrained, warm, discreet, culturally fluent.

**Style:** Direct, evidence-aware, bilingual where useful, transparent about uncertainty, never fear-based or grandiose.

**Personality:** Accountable, thoughtful, private, rigorous, human.

## Proof Points

**What is supported now:**

- Large reachable diaspora populations exist.
- Competitors transact across a wide price ladder.
- Public customer language supports calculation trust, human accountability, no-remedy positioning, durable records, and another-perspective framing.
- No sampled competitor visibly combines the complete proposed operating model.

**What is not yet proven:**

- Zhiji conversion at US$388–488;
- trust in a premium brand-accountable service without a public practitioner identity;
- repeatable CAC;
- delivery under 3.5 hours;
- refund/chargeback rate;
- 30/90-day participation and decision-clarity improvement;
- healthy referral and repeat behavior;
- venture-scale demand.

Do not publish market-size scenarios, competitor list prices, or research thresholds as customer outcomes.

## Goals

**Business goal:** Validate a safe, profitable premium productized practice, then build the narrow human-plus-software operating system that improves quality, privacy, throughput, and delayed learning.

**Primary conversion action:** A qualified adult pays the calibration deposit and converts to a full-price core case.

**90-day target:** 40 interviews, approximately 2,500 relevant visits, and 30 completed full-price cases, at least 60% beyond the founder’s direct friend graph.

**Core evidence gates:** Full-price acceptance, refund/chargeback, delivery time, target gross margin, CAC, decision clarity and agency, 30/90-day participation, actual qualified referrals, safety, and processor/legal clearance.
...
- `docs/research/2026-07-10-market-product-synthesis.md`
- `docs/research/2026-07-10-customer-language.md`
- `docs/research/2026-07-10-validation-plan.md`
- `docs/research/2026-07-10-risk-register.md`
- `docs/research/data/competitor-matrix.csv`
- `docs/research/data/source-evidence-ledger.csv`
- `docs/research/data/market-sizing-model.csv`
