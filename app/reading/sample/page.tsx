...
// 判读书 — fictional walkthrough of the delivery structure, never client proof.
...
const DOC = {
  ...
  en: {
    ...
    no: "No. ZJ—DEMO · fictional walkthrough",
    delivered: "not client proof",
    reviewH: "Review",
    ...
    note: "This is a fictional walkthrough. It refers to no client and makes no claim about accuracy. It shows how the brief separates observations, facts, assumptions, actions, and counterexamples.",
